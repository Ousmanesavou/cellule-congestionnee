...
if uploaded_file:
    ...
    # Nettoyage
    df['Date'] = pd.to_datetime(df['Date'], errors='coerce').dt.date  # Date sans heure
    ...
    seuil_kpi = st.sidebar.slider("Seuil de Congestion (%)", min_value=0.0, max_value=100.0, value=1.0, step=0.1)
